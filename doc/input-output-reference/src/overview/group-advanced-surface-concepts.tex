...
This object is extensible, so additional pairs of these last two fields of this type can be added to the end of this object.  Below are several examples of how this input object would work under different scenarios in EnergyPlus.

In this first example, there is a Zone with three People objects associated with it. An example of how the ZoneMRTCalculation object and associated objects might be define is:
...
Zone,
  ...
  1,                       !- Type
  1,                       !- Multiplier
  3.4,                     !- Ceiling Height {m}
  340.0;                   !- Volume {m3}

People,
    West Wing Office People, !- Name
    West Wing Zone,        !- Zone or ZoneList or Space or SpaceList Name
    OccSched               !- Number of People Schedule Name
    ...
    ActSched,              !- Activity Level Schedule Name
    ...
    ClothingSched,         !- Clothing Insulation Schedule Name
    AirVelSched,           !- Air Velocity Schedule Name
    FANGER;                !- Thermal Comfort Model 1 Type

People,
    West Wing Service Center People, !- Name
    West Wing Zone,        !- Zone or ZoneList or Space or SpaceList Name
    OccSched               !- Number of People Schedule Name
    people,                !- Number of People Calculation Method
    10,                    !- Number of People
...
People,
    West Wing Reception People, !- Name
    West Wing Zone,        !- Zone or ZoneList or Space or SpaceList Name
    OccSched               !- Number of People Schedule Name
    people,                !- Number of People Calculation Method
    5,                     !- Number of People
...
In this example, all three People objects (\texttt{West Wing Office People}, \texttt{West Wing Service Center People}, and \texttt{West Wing Reception People}) are assigned directly to \texttt{West Wing Zone}, and the zone does not contain multiple spaces.

If \texttt{West Wing People} is the name of a People statement and is assigned to the Zone named \texttt{West Wing Zone} that contains the explicitly defined spaces \texttt{Oval Office}, \texttt{Staff Office}, and \texttt{Conference Room}, the original \texttt{West Wing People} would be split internally into three new People objects with the names that contain the Space name followed by the original people name.  This means that \texttt{West Wing People} would be replaced inside EnergyPlus by three People objects with the names \texttt{Oval Office West Wing People}, \texttt{Staff Office West Wing People}, and \texttt{Conference Room West Wing People}.  In this case, an example of the input would include the following objects:
...
Space,
  ...
  autocalculate,           !- Volume {m3}
  ,                        !- Floor Area {m2}
  Conference;              !- Space Type

People,
    West Wing People,      !- Name
    West Wing Zone,        !- Zone or ZoneList or Space or SpaceList Name
    OccSched               !- Number of People Schedule Name
    people,                !- Number of People Calculation Method
    30,                    !- Number of People
...
Finally, in a case where a the zone \texttt{West Wing Zone} contains two spaces, \texttt{Staff Office} and \\texttt{Conference Room}, that each have a People statement associated with it, \texttt{Staff Office People} and \texttt{Conference Room People}, respectively, the ZoneMRTCalculation fields would refer directly to these Space level People objects as shown below:
...
People,
  Staff Office People,   !- Name
  Staff Office,          !- Zone or ZoneList or Space or SpaceList Name
  OccSched               !- Number of People Schedule Name
  people,                !- Number of People Calculation Method
  20,                    !- Number of People
  ,                      !- People per Floor Area {person/m2}
...
People,
  Conference Room People, !- Name
  Conference Room,       !- Zone or ZoneList or Space or SpaceList Name
  OccSched               !- Number of People Schedule Name
  people,                !- Number of People Calculation Method
  10,                    !- Number of People
  ,                      !- People per Floor Area {person/m2}
...
ZoneMRTCalculation,
  West Wing Zone,         !- Zone Name
  Staff Office People,    !- People 1 Name
  0.8,
  Conference Room People, !- People 2 Name
  0.2;
\end{lstlisting}
>>>>>>> nrel/develop
